...
const DEFAULT_CONTENT: SiteContent = {
  ...
  about: {
    title: "О компании",
    description: "Мы специализируемся на комплексных решениях в области пожарной безопасности. Наша команда сертифицированных специалистов обеспечивает полный цикл работ от проектирования до технического обслуживания.",
  },
  solutions: {
    title: "Наши решения",
    items: [
